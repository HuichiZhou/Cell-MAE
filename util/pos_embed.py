...
def simulate_input(embed_dim=16, grid_size=8, cls_token=True):
    """
    ...
    print("Generated position embedding shape:", pos_embed.shape)
    print(pos_embed)

simulate_input(embed_dim=768, grid_size=14, cls_token=True)